  ...
  <main class="main-content">
    ...
    <div class="card mb-4">
      ...
      <div class="d-flex gap-2" style="flex-wrap:wrap;">
        <a href="cursos.php?accion=nuevo" class="btn btn-outline btn-lift"><?= icono('mas') ?> Nuevo curso</a>
        <a href="cursos.php"   class="btn btn-outline btn-lift"><?= icono('cursos') ?> Gestionar cursos</a>
        <a href="usuarios.php" class="btn btn-outline btn-lift"><?= icono('usuarios') ?> Ver estudiantes</a>
        <a href="examenes.php" class="btn btn-outline btn-lift"><?= icono('examen') ?> Gestionar exámenes</a>
